...
cc.Class({
    ...
    ballshot:function(){
        ...
        this.shoot();
        if(this.pathtype == 1) this.node.runAction(cc.sequence(cc.spawn(action,ballactX).easing(cc.easeOut(1.0)),cc.callFunc(function(){cc.audioEngine.play(this.HitGround, false, 0.5)},this),cc.spawn(cc.rotateBy(0.5,270),cc.cardinalSplineTo(0.5,[cc.v2(-50,-44),cc.v2(-70,-18),cc.v2(-111,-67)],0)).easing(cc.easeInOut(1.0)),cc.spawn(cc.rotateBy(0.3,180),cc.moveTo(0.3,-140,-67)).easing(cc.easeOut(1.0))))
